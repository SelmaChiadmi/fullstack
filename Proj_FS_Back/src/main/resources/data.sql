...
INSERT INTO t_employes (nom, prenom, mail, mdp, id_centre, is_med, is_admin, is_super_admin, telephone)
SELECT 'Nakib', 'Wassil', 'wnakib21@gmail.com', '$2y$10$1bWeql/sFeDHMFw.0GF.0u6ADIYED5GQrtc4MmaMBNsTFrPGDV.o.', 1, FALSE, FALSE, TRUE, 0678945678
WHERE NOT EXISTS (SELECT 1 FROM t_employes WHERE mail = 'wnakib21@gmail.com');
...
WHERE NOT EXISTS (SELECT 1 FROM t_employes WHERE mail = 'selma.chiadmiii@gmail.com');
